...
tokenizer = AutoTokenizer.from_pretrained('casehold/custom-legalbert', do_lower_case=True)
...
model = BertForSequenceClassification.from_pretrained("casehold/custom-legalbert", num_labels=2)
model.to(device)
...
# Save the model
output_dir = '/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/saved_model_single'
...
path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_cls_single/CaseLawBERT_cls_train"
...
path_dev_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_cls_single/CaseLawBERT_cls_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'cls')
np.save(path_dev_npy_file, vecs_dev)

print('npy file dev saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_cls_single/CaseLawBERT_cls_test"
...
path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_avg_single/CaseLawBERT_avg_train"
vecs_train = generate_np_files_for_emb(df_train, tokenizer, 'avg')
np.save(path_train_npy_file, vecs_train)

print('npy file train saved')

path_dev_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_avg_single/CaseLawBERT_avg_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'avg')
np.save(path_dev_npy_file, vecs_dev)

print('npy file dev saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_avg_single/CaseLawBERT_avg_test"
...
path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_max_single/CaseLawBERT_max_train"
vecs_train = generate_np_files_for_emb(df_train, tokenizer, 'max')
np.save(path_train_npy_file, vecs_train)

print('npy file train saved')

path_dev_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_max_single/CaseLawBERT_max_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'max')
np.save(path_dev_npy_file, vecs_dev)

print('npy file dev saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/CaseLawBERT_single/CaseLawBERT_npy_files_max_single/CaseLawBERT_max_test"
