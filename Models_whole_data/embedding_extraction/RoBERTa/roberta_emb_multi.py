...
output_dir = '/home/scurello/Thesis/Models_whole_data/transformers/RoBERTa/saved_model_multi'
...
path_val_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_cls_multi/RoBERTa_cls_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'cls')
np.save(path_val_npy_file, vecs_dev)

print('npy file dev saved')

path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_cls_multi/RoBERTa_cls_train"
...
path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_cls_multi/RoBERTa_cls_test"
...
path_val_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_avg_multi/RoBERTa_avg_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'avg')
np.save(path_val_npy_file, vecs_dev)

print('npy file dev saved')

path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_avg_multi/RoBERTa_avg_train"
vecs_train = generate_np_files_for_emb(df_train, tokenizer, 'avg')
np.save(path_train_npy_file, vecs_train)

print('npy file train saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_avg_multi/RoBERTa_avg_test"
...
path_val_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_max_multi/RoBERTa_max_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'max')
np.save(path_val_npy_file, vecs_dev)

print('npy file dev saved')

path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_max_multi/RoBERTa_max_train"
vecs_train = generate_np_files_for_emb(df_train, tokenizer, 'max')
np.save(path_train_npy_file, vecs_train)

print('npy file train saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/RoBERTa_multi/RoBERTa_npy_files_max_multi/RoBERTa_max_test"
