...
model = LEDForSequenceClassification.from_pretrained("nsi319/legal-led-base-16384", num_labels=2)
model.to(device)
    ...
    for step, batch in enumerate(train_dataloader):
        ...
        if step%1000 == 0 and not step == 0:
           ...
           for batch in validation_dataloader:
             ...
             print('stampa b_input_ids')
             print(b_input_ids)
             print('stampa b_input_mask')
             print(b_input_mask)
             print('stampa b_labels')
             print(b_labels)
             with torch.no_grad():        
               outputs = model(b_input_ids, attention_mask=b_input_mask, labels=b_labels)
...
# Save the model
output_dir = '/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/saved_model_single'
...
path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_cls_single/LegalLED_cls_train"
...
path_dev_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_cls_single/LegalLED_cls_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'cls')
np.save(path_dev_npy_file, vecs_dev)

print('npy file dev saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_cls_single/LegalLED_cls_test"
...
path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_avg_single/LegalLED_avg_train"
vecs_train = generate_np_files_for_emb(df_train, tokenizer, 'avg')
np.save(path_train_npy_file, vecs_train)

print('npy file train saved')

path_dev_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_avg_single/LegalLED_avg_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'avg')
np.save(path_dev_npy_file, vecs_dev)

print('npy file dev saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_avg_single/LegalLED_avg_test"
...
path_train_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_max_single/LegalLED_max_train"
vecs_train = generate_np_files_for_emb(df_train, tokenizer,'max')
np.save(path_train_npy_file, vecs_train)

print('npy file train saved')

path_dev_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_max_single/LegalLED_max_dev"
vecs_dev = generate_np_files_for_emb(df_dev, tokenizer, 'max')
np.save(path_dev_npy_file, vecs_dev)

print('npy file dev saved')

path_test_npy_file = "/home/scurello/Thesis/Models_whole_data/transformers_sentence_level/LegalLED_single/LegalLED_npy_files_max_single/LegalLED_max_test"
